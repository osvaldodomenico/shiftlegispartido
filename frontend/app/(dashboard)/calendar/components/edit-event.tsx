                                ...
                                <div className="col-span-12">
                                    ...
                                    >
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="PESSOAL" id="Personal" className="border border-neutral-400" required />
                                            <Label htmlFor="Personal" className="font-medium text-sm flex items-center gap-1">
                                                <span className="w-2 h-2 bg-green-500 rounded-full"></span> Pessoal
                                            </Label>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="TRABALHO" id="Business" className="border border-neutral-400" required />
                                            <Label htmlFor="Business" className="font-medium text-sm flex items-center gap-1">
                                                <span className="w-2 h-2 bg-blue-500 rounded-full"></span> Trabalho
                                            </Label>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="FAMÍLIA" id="Family" className="border border-neutral-400" required />
                                            <Label htmlFor="Family" className="font-medium text-sm flex items-center gap-1">
                                                <span className="w-2 h-2 bg-yellow-500 rounded-full"></span> Família
                                            </Label>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="IMPORTANTE" id="Important" className="border border-neutral-400" required />
                                            <Label htmlFor="Important" className="font-medium text-sm flex items-center gap-1">
                                                <span className="w-2 h-2 bg-purple-500 rounded-full"></span> Importante
                                            </Label>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="FERIADO" id="Holiday" className="border border-neutral-400" required />
                                            <Label htmlFor="Holiday" className="font-medium text-sm flex items-center gap-1">
                                                <span className="w-2 h-2 bg-red-500 rounded-full"></span> Feriado
                                            </Label>
                                        </div>
                                    </RadioGroup>
                                </div>
