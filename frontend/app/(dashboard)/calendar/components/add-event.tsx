...
const AddEvent: React.FC<AddEventProps> = ({ onAddEvent }) => {
    ...
    const handleModalFormSubmit = (event: any) => {
        ...
        const newEvent = {
            id: Date.now(),
            title: name,
            color: label === "PESSOAL" ? "bg-green-500" :
                label === "TRABALHO" ? "bg-primary" :
                    label === "FAMÍLIA" ? "bg-yellow-500" :
                        label === "IMPORTANTE" ? "bg-purple-500" :
                            "bg-red-500",
            label: label,
            startTime: value,
            endTime: endValue,
        ...
        setTimeout(() => {
            ...
            toast.success(
                <span>
                    <strong>{name}</strong> <br /> Evento salvo com sucesso.
                </span>
            );
        }, 500);
    }
                        ...
                        <form action="#" onSubmit={handleModalFormSubmit}>
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                <div className="col-span-12">
                                    <label htmlFor="title" className="inline-block font-semibold text-neutral-600 dark:text-neutral-200 text-sm mb-2">Título do evento</label>
                                    <Input type="text" id="title" value={name} onChange={(event) => setName(event.target.value)} className="form-control border-neutral-300 px-5 shadow-none w-full h-[46px] rounded-lg" placeholder="Informe o título do evento" required />
                                </div>
                                ...
                                <div className="col-span-12">
                                    ...
                                    >
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="PESSOAL" id="Personal" className='border border-neutral-400'
                                                required />
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="TRABALHO" id="Business" className='border border-neutral-400'
                                                required />
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="FAMÍLIA" id="Family" className='border border-neutral-400'
                                                required />
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="IMPORTANTE" id="Important" className='border border-neutral-400'
                                                required />
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="FERIADO" id="Holiday" className='border border-neutral-400'
                                                required />
                                ...
                                <div className="col-span-12">
                                    <DialogFooter>
                                        <DialogClose asChild>
                                            <Button variant="outline" className='h-[50px] px-8 border-red-600 hover:bg-red-100 hover:bg-red-600 text-red-600'>Cancelar</Button>
                                        </DialogClose>
