...
export const metadata: Metadata = {
  title: "Recuperar Senha | Shift Partido",
  description:
    "Solicite um link de recuperação de senha para voltar a acessar a plataforma.",
};
      ...
      <div className="lg:w-1/2 w-full py-8 px-6 flex flex-col justify-center">
        <div className="lg:max-w-[464px] w-full mx-auto">
          ...
          <div>
            ...
            <h4 className="font-semibold mb-3">Recuperar acesso</h4>
            <p className="mb-8 text-neutral-500 dark:text-neutral-300 text-lg">
              Informe o e-mail vinculado ao seu usuário para receber as instruções de recuperação.
            </p>
          </div>
