...
export const metadata: Metadata = {
  title: "Criar Conta | Shift Partido",
  description:
    "Cadastre um novo acesso para operar os módulos internos da plataforma.",
};
      ...
      <div className="lg:w-1/2 w-full py-8 px-6 flex flex-col justify-center">
        <div className="lg:max-w-[464px] w-full mx-auto">
          ...
          <div>
            ...
            <h4 className="font-semibold mb-3">Criar acesso</h4>
            <p className="mb-8 text-neutral-500 dark:text-neutral-300 text-lg">
              Preencha os dados abaixo para criar um novo usuário interno.
            </p>
          </div>
