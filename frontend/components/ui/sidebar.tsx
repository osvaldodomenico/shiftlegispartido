  ...
  if (isMobile) {
    ...
    return (
      <div
        ...
        data-slot="sidebar"
        data-mobile="true"
        className="fixed inset-y-0 left-0 z-40 flex h-full w-(--sidebar-width) flex-col bg-white p-0 dark:bg-[#273142] md:hidden"
        style={
          {
      ...
      >
        ...
        <button
          ...
          className="absolute top-3 right-3 rounded-md px-2 py-1 text-sm text-neutral-600 dark:text-neutral-200"
